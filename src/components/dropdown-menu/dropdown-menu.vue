...
<template>
    <div>
        <dropdown-menu-root :modal="props.modal">
            <dropdown-menu-trigger :class="st(classes.root, classes.trigger)" as-child>
                <slot name="trigger" />
            ...
            <dropdown-menu-portal>
                ...
                >
                    ...
                    <dropdown-menu-arrow v-if="props.withArrow" :class="classes.arrow" />
                </dropdown-menu-content>
            </dropdown-menu-portal>
        </dropdown-menu-root>
    </div>
